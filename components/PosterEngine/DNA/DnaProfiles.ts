...
illustrationStyle: "Engraving",},
  ...
  "augusta-national": {
    ...
    moods: ["Prestigious", "Elegant", "Scenic", "Historic", "Iconic"],
    primaryStyle: "Gallery",
    colourPalette: ["#10271D", "#B8A66A", "#F1EBDD", "#B83B62"],
    heroFocus: "Rolling fairways, azaleas and immaculate landscape",
    atmosphere: "Tranquil spring light with understated perfection",
    typography: "Luxury",
    informationDensity: "Minimal",
    illustrationPriority: "Landscape",
    preferredLayouts: ["GalleryMinimal", "CollectorEditorial", "AtlasOverlay"],
    signatureElements: ["Azaleas", "Rolling fairways", "Pines", "Stone bridge", "Quiet", "Perfection"],
    heroStyle: "Aerial",
    mapStyle: "Plan",
    headerStyle: "Editorial",
    borderStyle: "Museum",
