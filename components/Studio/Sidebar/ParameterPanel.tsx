    ...
    <>
      ...
      <div className="mt-5 space-y-2">
        {parameters.map((parameter) => (
          <label key={parameter.id} className="flex cursor-pointer items-center justify-between rounded-lg border border-white/8 bg-white/[0.025] px-3 py-3 transition hover:bg-white/[0.05]">
